BEGIN;
    ...
    CREATE TABLE school_follows (
        ...
        CONSTRAINT sf_fk_user FOREIGN KEY (user_id) REFERENCES users (id),
    ...
    CREATE TABLE posts (
        ...
        hottest_on DATE,
        hidden BOOLEAN,
        CONSTRAINT po_fk_user FOREIGN KEY (user_id) REFERENCES users (id),
    ...
    CREATE TABLE comments (
        ...
        score INTEGER,
        hidden BOOLEAN,
        CONSTRAINT co_fk_user FOREIGN KEY (user_id) REFERENCES users (id),
        CONSTRAINT co_fk_pos FOREIGN KEY (post_id) REFERENCES posts (id)
    );
    ...
    CREATE TABLE votes (
        ...
        post_id INTEGER NOT NULL,
        comment_id INTEGER,
        CONSTRAINT vot_fk_user FOREIGN KEY (user_id) REFERENCES users (id),
    ...
    CREATE TABLE saved_posts (
        ...
        user_id INTEGER NOT NULL,
        post_id INTEGER NOT NULL,
        CONSTRAINT sap_fk_user FOREIGN KEY (user_id) REFERENCES users (id),
    ...
    CREATE TABLE saved_comments (
        ...
        CONSTRAINT sco_fk_user FOREIGN KEY (user_id) REFERENCES users (id),
        CONSTRAINT sco_fk_pos FOREIGN KEY (comment_id)REFERENCES comments (id)
    );
    ...
    CREATE TABLE feedbacks (
        ...
        user_id INTEGER NOT NULL,
        content TEXT NOT NULL,
        CONSTRAINT feb_fk_user FOREIGN KEY (user_id) REFERENCES users (id)
    );
    ...
    CREATE TABLE reports (
        ...
        CONSTRAINT rep_fk_user FOREIGN KEY (user_id) REFERENCES users (id),
        CONSTRAINT rep_fk_repo FOREIGN KEY (reported_by) REFERENCES users (id)
    );
